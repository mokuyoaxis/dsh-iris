  ...
  function apply(ctx) {
    ...
    var CARD_DEFS = [
      ...
      { action: 'transcribe', title: '🎙️ 音频转写', fields: [
        { key: 'audio_path', label: '音频路径', placeholder: '/path/audio.wav' }] },
      { action: 'video_frames', title: '🎞️ 视频抽帧', fields: [
        { key: 'video_path', label: '视频路径', placeholder: '/path/video.mp4' },
      ...
      { action: 'look', title: '👁 看图', capability: 'vision', fields: [
        { key: 'image_path', label: '图片路径', placeholder: '/path/image.png' },
      ...
      { action: 'diff', title: '📷 像素差异', fields: [
        { key: 'image_a_path', label: '图 A 路径', placeholder: '/path/a.png' },
      ...
      { action: 'ocr', title: '📄 长截图 OCR', capability: 'vision', fields: [
        { key: 'image_path', label: '图片路径', placeholder: '/path/long.png' },
