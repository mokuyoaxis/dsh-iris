...
window.__ModuleLoader__.load({ id: 'dsh-iris', factory: (require) => {
  ...
  function apply(ctx) {
    ...
    function ActionCard(props) {
      ...
      return React.createElement('div', { className: 'iris-act-card' + (open ? ' open' : '') },
