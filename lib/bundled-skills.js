...
export function registerBundledSkills(host) {
  const registry = requireHostPort(host, 'skills', '注册随包 Skill');
  if (typeof registry.register !== 'function') throw new Error('Host skills 端口缺少 register');
